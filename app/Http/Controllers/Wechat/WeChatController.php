...
class WeChatController extends Controller
{
    ...
    "所有的技能均支持语音输入和语音回复（如果需要语音回复，可以试着说：设置语音回复，如果需要恢复文字恢复模式，输入：设置文字回复，如需切换声音，输入：设置女生回复，或者，设置男生回复 即可）\n" .
    "现在你可以使用以下技能：\n" .
    ...
    "技能5：AI春联创作模式：输入一个主题词，我便会帮你作出一个文采飞扬的对联，还有横批哦，春节拜年不重样，AI助你会更棒；快试着说：我要作春联体验吧，如需退出，则输入“退出”即可 \n" .
